  ...
  return (
    <section className="container m-auto flex flex-col gap-10 px-4 py-8 text-white md:py-16 xl:px-16">
      <div className="flex flex-col gap-5">
        ...
        <div className="flex items-center gap-10 text-[15px] md:text-[20px]">
      ...
      <div className="flex flex-col gap-10 lg:flex-row">
        <div className="border-grey-15 text-grey-60 flex flex-col gap-5 rounded-lg border p-5 lg:h-full lg:w-full">
          <div className="border-grey-15 border-b pb-5">
            <h4 className="mb-2.5 text-[20px] font-semibold text-white md:text-2xl">
              Description
            </h4>
