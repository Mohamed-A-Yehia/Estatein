    ...
    <section className="container m-auto flex flex-col gap-10 px-4 py-8 text-white md:py-16 xl:px-16">
      <div className="grid gap-5 lg:grid-cols-2">
        <div className="flex flex-col items-center justify-center">
          ...
          />
          <div className="border-grey-15 flex h-fit w-fit flex-col gap-5 rounded-lg border bg-[url('/images/images-bg.webp')] bg-cover bg-center p-5">
        ...
        <div className="w-full lg:grid lg:grid-cols-2 lg:gap-5">
          ...
          <div className="border-grey-15 rounded-lg border p-5">
            ...
            <p className="text-grey-60 text-[15px] md:text-lg">
              ...
              guide you in spreading your investments across various property
              types and locations
            </p>
          </div>
        </div>
