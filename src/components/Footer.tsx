...
function Footer() {
  return (
    <footer className="m-auto p-5 pt-10 pb-10 lg:container lg:flex lg:justify-between lg:gap-5">
      <div className="flex flex-col text-white lg:mt-8">
        ...
        <div className="relative w-fit">
          <input
            ...
            id=""
            className="border-grey-15 mt-5 w-fit rounded-lg border px-12 py-2.5 text-center"
          />
          <MdOutlineEmail
            size={30}
