    ...
    <form className="border-grey-20 placeholder:bg-grey-60 grid gap-5 rounded-lg border p-5 lg:grid-cols-4 lg:grid-rows-5 lg:items-center lg:p-10">
      <div className="flex flex-col gap-2.5">
        ...
        <input
          ...
          className="bg-grey-08 border-grey-20 focus:outline-grey-30 rounded-lg border px-2.5 py-2.5 focus:outline"
        />
      </div>
      <div className="flex flex-col gap-2.5">
      ...
      <div className="flex flex-col gap-2.5 lg:col-span-4">
        ...
        <textarea
          ...
          className="bg-grey-08 border-grey-20 focus:outline-grey-30 h-30 rounded-lg border px-4 py-2.5 text-justify focus:outline"
        />
      </div>
