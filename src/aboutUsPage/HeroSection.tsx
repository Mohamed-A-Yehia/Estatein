...
function HeroSection() {
  return (
    <section className="m-auto grid w-full grid-rows-2 flex-col items-center gap-10 p-4 py-8 md:container md:grid-rows-1 md:p-0 lg:grid-cols-2 lg:gap-15 lg:pt-16 lg:pb-16">
      <div>
        <SectionIntro
          title="Our Journey"
